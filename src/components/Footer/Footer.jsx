...
export default function Footer() {
  return (
    <section className="relative overflow-hidden w-full block bg-gradient-to-r from-[#ffffff] to-[#a6a6a6]">
        ...
        <div className="flex flex-wrap items-center justify-between">
          ...
          <div className="w-auto">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <a className="font-medium text-black hover:text-gray-700" href="#">
                  Privacy Policy
                </a>
              </li>
              <li className="p-5">
          ...
          <div className="w-auto">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="https://www.facebook.com/profile.php?id=61564641193483">
              ...
              <div className="w-auto p-1.5">
                <a href="https://x.com/KohalMaheshwar">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="14"
                      height="11"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/thakur_maheshwar_kohal/">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
