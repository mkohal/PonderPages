...
function App() {
  ...
  useEffect(() => {
    // 4 yeh sbse pehle run hota hai project mai
    authService
      .getCurrentUser() // 5 pehle hum check krege ki current user hai ki nhi
      .then((userData) => {
        // 6 fr .then() mai response recieve krege
        if (userData) {
          // 7 agr userData aya hai to hum dispatch krege
